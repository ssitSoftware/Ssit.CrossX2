...
using Ssit.CrossX2.UI.Handlers.Markdown;
using Ssit.CrossX2.UI.Internal;
...
internal class UiAppBuilder(IIoCContainer container, IAppHost appHost) : IUiAppBuilder
{
