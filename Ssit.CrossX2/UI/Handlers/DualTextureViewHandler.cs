...
public class DualTextureViewHandler : BackgroundHandler<DualTextureView>
{
    ...
    protected virtual RgbaColor? Color(IRenderer renderer) => AttachedView.Color?.GetColor(PaletteSource, renderer, _colorSource);
    protected virtual RgbaColor? OutlineColor(IRenderer renderer) => AttachedView.OutlineColor?.GetColor(PaletteSource, renderer, _colorSource);
